      ...
      <v-card-text style="height: 130px;">
        <v-layout row wrap fill-height>
          <v-flex xs12 fill-height>
            <div class="ml-2">Select the checkbox below to confirm that you understand the impact of deleting this user:</div>
            <!-- form -->
            <form ref="ConfirmDeleteForm">
              <v-layout align-center class="mt-2 ml-2">
                <v-checkbox
                  ...
                  class="shrink mr-2"
                ></v-checkbox>
                <span class="error--text">Delete this user</span>
              </v-layout>
            </form>
            <!-- end form -->
          </v-flex>
  ...
  export default {
    ...
    methods: {
      ...
      confirmDelete (userId) {
        this.axios.delete('admin/user/' + userId)
          .then(response => {
